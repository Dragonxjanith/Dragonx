...
// ════════════════════PLUGGINS SUCCESS🍁🍁🍁
        ...
        console.log(
         ...
         if (config.LANG == 'EN') {
             await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/photo_2022-02-11_08-03-49.jpg"), MessageType.image, { caption: `✨🙈 Hellow !! ${conn.user.name} \n\n*🇱🇰 Welcome To ᗪᖇ𝙰𝙶𝚘𝚗 Ӽ WhatsApp User Bot  :│🇱🇰*\n\n\n Your Bot Working  As ${config.WORKTYPE} 🇱🇰.\n\n*🇱🇰│⎝🛡️ Dragon x 🛡️⎠ WORKING Your Account*\n\n*🇱🇰▷ Use the 🚀.menu command to get bot menu...*\n\n\n*🇱🇰 ⎝🛡️ Dragon x 🛡️⎠ is a powerfull WhatsApp robot developed by =Janith sadanuwan.*\n\n*🚀 This is your LOG number. Avoid using the command here.\n\n🇱🇰 .up Command use for new items*\n\n`});
             
         } else if (config.LANG == 'SI') {
             await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/photo_2022-02-11_08-03-49.jpg"), MessageType.image, { caption: `✨🙈 අයුබොවන් !! ${conn.user.name} \n\n*🇱🇰 සාදරයෙන් ᗪᖇ𝙰𝙶𝚘𝚗 Ӽ WhatsApp User Bot  වෙත පිලිගන්නවා :│*\n\n\n ඔබේ Bot ${config.WORKTYPE} ලෙස ක්‍රියාකරයි.\n\n*🇱🇰│⎝🛡️ Dragon x 🛡️⎠ ඔබගේ ගිණුමේ දැන් සක්‍රියයි*\n\n*🇱🇰 ⎝🛡️ Dragon x 🛡️⎠ bot සම්පූර්න මෙනුව ලබා ගැනීමට 🇱🇰.Menu විධානය භාවිතා කරන්න...*\n\n\n*🇱🇰 ⎝🛡️ Dragon x 🛡️⎠ යනූ සීඝ්‍රයෙන් වර්ධනය වන Whatsapp රොබෝවෙකි..⎝🛡️ Dragon x 🛡️⎠ වෙත ලැබෙන නව අංග හා යතාවත්කාලින කිරිම් ලබා ගැනීමට🇱🇰 .up විධානය භාවිතා කරන්න..*\n\n*🚀මෙය ඔබගේ LOG අංකයයි.මෙහි විධාන භාවිතයෙන් වළකින්න.*\n\n\n\n*🇱🇰අපගේ Suport Group එකට  Join වෙන්න* - *https://chat.whatsapp.com/LhWT3s3koJx6kkUROPtUeD*`});
             
         } else {
             await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/photo_2022-02-11_08-03-49.jpg"), MessageType.image, { caption: `✨🙈 Hellow !!  ${conn.user.name} \\nn*🇱🇰 Welcome To ᗪᖇ𝙰𝙶𝚘𝚗 Ӽ WhatsApp User Bot  :│🇱🇰*\n\n\n Your Bot Working  As ${config.WORKTYPE} 🇱🇰.\n\n*🇱🇰 │⎝🛡️ Dragon x 🛡️⎠ WORKING Your Account*\n\n*🇱🇰▷ Use the 🚀.menu command to get bot menu...*\n\n\n*🇱🇰 ⎝🛡️ Dragon x 🛡️⎠ is a powerfull WhatsApp robot developed by Janith sadanuwan.*\n\n*🚀 This is your LOG number. Avoid using the command here.\n\n🇱🇰 .up Command use for new items*\n\n\n\n*🇱🇰Join our Suport Group* - *https://chat.whatsapp.com/LhWT3s3koJx6kkUROPtUeD*`});
        }
     });
