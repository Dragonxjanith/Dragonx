...
if (config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'antilink ?(.*)', fromMe: true, desc: l_dsc, usage: '.antilink on / off' }, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: true}, (async (message, match) => {
    ...
    Trex.addrex({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: 'dragonx' + title + '.mp3', mimetype: 'audio/mpeg',quoted: message.data});
            });
    }));
    ...
    Trex.addrex({ pattern: 'github ?(.*)', fromMe: true, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Trex.addrex({pattern: 'asong ?(.*)', fromMe: false, desc: 'document song - i phone working'}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'asong ?(.*)', fromMe: true}, (async (message, match) => { 
