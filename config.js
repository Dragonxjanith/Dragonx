...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Janith' : process.env.OWNER_NAME,
    ...
    GROUPN1: process.env.GROUP_DETAILS === undefined ? 'DRAGONX OFFICIAL SUPPORT': process.env.GROUP_DETAILS,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/LhWT3s3koJx6kkUROPtUeD': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'DRAGONX OFFICIAL TEST': process.env.GROUP_NAME_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? ' ⎝🛡️ DRAGONX 🛡️⎠ ' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Dragon x' : process.env.BOT_NAME,
    ...
    TREX: process.env.TREX === undefined ? 'dargonx.' : process.env.TREX,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'dargonx.' : process.env.TAG_HEADER,
